...
500500r: clean $(EXEC)
	mkdir outputs
	./$(EXEC) examples/500_500r.b outputs/500_500r.t outputs/500_500r.f outputs/500_500r.p
...
m10001000: $(EXEC)
	mkdir moutputs
	$(VALGRIND) ./$(EXEC) examples/1000_1000.b moutputs/1000_1000.t moutputs/1000_1000.f moutputs/1000_1000.p
